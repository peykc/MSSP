export function initGlobalTooltip() {
  ...
  document.addEventListener("mouseover", (event) => {
    ...
    if (el.closest(".launch-search, .episode-row, .full-player__queue-panel .episode-row, .full-player__compact .episode-row, .hero-details .full-player__title, .mini-player__title, .full-player .full-player__title")) return;
