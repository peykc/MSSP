...
export const dom = {
  ...
  launchFavoritesButton: getRequiredElement("launchFavoritesButton"),
  launchFavoritesCount: getRequiredElement("launchFavoritesCount"),
  launchA2hsButton: getRequiredElement("launchA2hsButton"),
  a2hsModal: getRequiredElement("a2hsModal"),
  a2hsDialog: getRequiredElement("a2hsDialog"),
  a2hsDragHandle: getRequiredElement("a2hsDragHandle"),
  a2hsBrandMark: getRequiredElement("a2hsBrandMark"),
  a2hsShareButton: getRequiredElement("a2hsShareButton"),
  ...
  patreonRssDragHandle: getRequiredElement("patreonRssDragHandle"),
  patreonRssInfo: getRequiredElement("patreonRssInfo"),
  patreonRssGuide: getRequiredElement("patreonRssGuide"),
  patreonRssGuideSwitch: getRequiredElement("patreonRssGuideSwitch"),
  patreonRssWebGuideTab: getRequiredElement("patreonRssWebGuideTab"),
  patreonRssAppGuideTab: getRequiredElement("patreonRssAppGuideTab"),
  patreonRssWebGuide: getRequiredElement("patreonRssWebGuide"),
  patreonRssAppGuide: getRequiredElement("patreonRssAppGuide"),
  patreonRssWebGuideVisual: getRequiredElement("patreonRssWebGuideVisual"),
  patreonRssAppGuideVisual: getRequiredElement("patreonRssAppGuideVisual"),
  patreonRssBody: getRequiredElement("patreonRssBody"),
  ...
  globalSearchResults: getRequiredElement("globalSearchResults"),
  statsView: getRequiredElement("statsView"),
  statsViewScroller: getRequiredElement("statsViewScroller"),
  statsBackButton: getRequiredElement("statsBackButton"),
  ...
  heroCoverFrame: getRequiredElement("heroCoverFrame"),
  heroCover: getRequiredElement("heroCover"),
  heroCoverStar: getRequiredElement("heroCoverStar"),
  ...
  episodeListEmpty: getRequiredElement("episodeListEmpty"),
  ...
  playerSpeedControl: getRequiredElement("playerSpeedControl"),
  playerSpeedToggle: getRequiredElement("playerSpeedToggle"),
  playerSpeedValue: getRequiredElement("playerSpeedValue"),
  playerSpeedPanel: getRequiredElement("playerSpeedPanel"),
  playerSpeedBarrel: getRequiredElement("playerSpeedBarrel"),
