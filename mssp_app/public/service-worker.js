...
const SHELL_PATHS = [
  ...
  "./css/episode-list.css?v=fav-empty-a",
  "./css/episode-details.css?v=fav-empty-b",
  "./css/filters.css",
  "./css/tooltip.css",
  ...
  "./js/statsPageView.js",
  "./js/libraryView.js?v=fav-empty-a",
  "./js/launchSplash.js",
  ...
  "./js/player/playerView.js?v=cover-ambient-g",
